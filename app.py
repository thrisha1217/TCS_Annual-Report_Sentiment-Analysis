...
# --- Page Configuration ---
st.set_page_config(
    page_title="Annual Report NLP Analysis",
    page_icon="📄",
    layout="wide"
)
...
def read_pdf_to_dataframe(uploaded_file):
    """Reads an uploaded PDF file and extracts text into a pandas DataFrame."""
...
# --- Main Application ---
st.title("📄 Annual Report NLP Analysis")
st.markdown("Upload an annual report in PDF format to begin the analysis.")
...
if uploaded_file is not None:
    ...
    if not df.empty:
        ...
        with st.spinner("Generating word cloud..."):
            ...
            wordcloud = WordCloud(width=800, height=400, background_color='white', colormap='viridis').generate(full_text_corpus)
